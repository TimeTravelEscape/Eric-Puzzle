...
const config = {
    ...
    finalPassword: 'ERIC',
    puzzleAnswers: [
        "43254","14","Velcro","319","16","31124111111","Globe","4","1259","Find the","Cake!"
    ],
    puzzles: [
        {
            title: "Hints",
            hints: [
                ...
                { text: "Password is 43254", penalty: 300 }
            ]
        },
        {
            title: "Hints",
        ...
        },
        {
            ...
            hints: [
                ...
                { text: "The answer is Velcro", penalty: 300 }
            ]
        },
        {
            title: "Hints",
        ...
        },
        {
            ...
            hints: [
                ...
                { text: "The answer is 16. The missing number is solved as 4² = 16", penalty: 300 }
            ]
        },
        {
            title: "Hints",
            hints: [
                ...
                { text: "The passcode is 31124111111", penalty: 300 }
            ]
        },
        {
            title: "Hints",
        ...
        },
        {
            ...
            hints: [
                ...
                { text: "What does a watch tell?", penalty: 55 },
                { text: "Clock or Time is the answer. If it is 8 o'clock, and 8 hours are added, the time becomes 4 o'clock.", penalty: 100 }
            ]
        },
        {
            title: "Hints",
            hints: [
                { text: "What numbers are missing from the entire card. You need four numbers including the 5!", penalty: 25 },
